...
class RefreshPhysics extends ScrollPhysics {
  ...
  bool shouldAcceptUserOffset(ScrollMetrics position) {
    // lambiengcode: implement shouldAcceptUserOffset
  ...
  @override
  // lambiengcode: implement runtimeType
  ...
  double applyPhysicsToUserOffset(ScrollMetrics position, double offset) {
    // lambiengcode: implement applyPhysicsToUserOffset
    viewportRender ??=
  ...
  Simulation? createBallisticSimulation(
    ...
    // lambiengcode: implement createBallisticSimulation
    viewportRender ??=
        findViewport(controller!.position?.context.storageContext);
    ...
    if ((position.pixels > 0 &&
      ...
      return BouncingScrollSimulation(
        ...
        // lambiengcode:(abarth): We should move this constant closer to the drag end.
