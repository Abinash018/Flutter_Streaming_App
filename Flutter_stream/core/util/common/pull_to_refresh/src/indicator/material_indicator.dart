...
class _MaterialClassicHeaderState
  ...
  Widget buildContent(BuildContext context, RefreshStatus? mode) {
    // lambiengcode: implement buildContent
  ...
  void onOffsetChange(double offset) {
    // lambiengcode: implement onOffsetChange
    if (!floating) {
  ...
  void onModeChange(RefreshStatus? mode) {
    // lambiengcode: implement onModeChange
  ...
  @override
  void resetValue() {
    // lambiengcode: implement resetValue
...
class WaterDropMaterialHeader extends MaterialClassicHeader {
  ...
  @override
  State<StatefulWidget> createState() {
    // lambiengcode: implement createState
...
class _WaterDropMaterialHeaderState extends _MaterialClassicHeaderState {
  ...
  @override
  void initState() {
    // lambiengcode: implement initState
    super.initState();
  ...
  @override
  void didChangeDependencies() {
    // lambiengcode: implement didChangeDependencies
    super.didChangeDependencies();
    final ThemeData theme = Theme.of(context);
    _valueColor = _positionController.drive(
      ColorTween(
...
class _WaterPainter extends CustomPainter {
  ...
  bool shouldRepaint(_WaterPainter oldDelegate) {
    // lambiengcode: implement shouldRepaint
